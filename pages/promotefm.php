                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Adjust the rank of a member of the <?php echo $ftext; ?>
                        </h1>
                    </div>
                </div>
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <form method="POST" action="">
                                            ...
                                            <label>Rank</label>
                                            <input type="text" id="rank" name="rank" class="form-control" placeholder="1-6">
                                        </div>
                                        <button type="submit" class="btn btn-default">Adjust Rank</button>

                                        <p><i>NB: Use the name of the player like this: First_Last</i></p>
                                        </form>
                                        <?php
                                        if(!empty($_POST['cname']) && !empty($_POST['rank'])) {
                                            ...
                                            $query1 = $con->prepare("UPDATE `accounts` SET Rank=".$rank." WHERE `Username` = '".$account."'");
                                            $query1->execute();
                                            //var_dump($query1);

                                            echo "<b><span style='color:green'>You've successfully adjusted the rank of ".$account." to ".$rank."!</span></b>";
