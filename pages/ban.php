                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <button type="submit" class="btn btn-default">Ban Account</button>
                                        ...
                                        if(!empty($_POST['cname']) && !empty($_POST['reason'])) {
                                            ...
                                            $query1 = $con->prepare("UPDATE `accounts` SET Band='1', PermBand='1' WHERE `id` = ".$rData['id']."");
                                            $query1->execute();
                                            //var_dump($query1);
                                            ...
                                            $reason = $_POST['reason'];
                                            $query2 =  $con->prepare("INSERT INTO `ucp_logs` (log, admin, against) VALUES ('In-Game Ban: ".$reason."', '".$admin."','".$player."')");
                                            $query2->execute();

                                            echo "<b><span style='color:green'>Player banned successfully! DO NOT FORGET TO POST A BAN REPORT IN THE STAFF SECTION!</span></b>";
                                        } else {
